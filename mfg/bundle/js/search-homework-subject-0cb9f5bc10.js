	...
	var searchHomeworkSubject = {
	    ...
	    initBtns: function(){
	        ...
	        $handler.delegate('.homework-comment', 'touchend', function(){
	            location.href = encodeURI('./homework-comment-7bb62cd285.html' + '?stage-subject-name=' + $(".course-name").html() + '&homework-id=' + util.getQueryString("homework-id"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+=' ';
	if(QuestionCount == 1){
	$out+=' <div class="homework-comment"> <img class="search" src="../bundle/img/search-ace2d3abe7.png"> ';
	if(homeworkStatus == 3){
	$out+=' <span>忽略原因</span> ';
	}else{
	$out+=' <span>查看评语</span> ';
	...
	$out+=' <div class="some-subjects"> <div class="homework-comment border-right w49 fl"> <img class="search" src="../bundle/img/search-ace2d3abe7.png"> ';
	if(homeworkStatus == 3){
	$out+=' <span>忽略原因</span> ';
	}else{
	$out+=' <span>查看评语</span> ';
	}
	$out+=' </div> <div class="right-btn w50 fl"> <img src="../bundle/img/right-text-d230cb1e77.png"> <span>下一题</span> </div> <div> ';
	}
	$out+=' ';
	}else if(num >= QuestionCount){
	$out+=' <div class="last left-btn"> <img src="../bundle/img/left-text-5685afef8e.png"> <span>上一题</span> </div> ';
	}else{
	$out+=' <div class="middle"> <div class="left-btn border-right w49 fl"> <img class="search" src="../bundle/img/left-text-5685afef8e.png"> <span>上一题</span> </div> <div class="right-btn w50 fl"> <img src="../bundle/img/right-text-d230cb1e77.png"> <span>下一题</span> </div> </div> ';
	}
	return new String($out);
	});
