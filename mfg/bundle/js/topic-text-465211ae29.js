...
/***/ function(module, exports, __webpack_require__) {
	...
	$out+='</span> <img src="../bundle/img/right-73475a442e.png" class="right"> </li> ';
	}else{
	$out+=' <li data-id="';
	$out+=$escape($value.id);
	$out+='"> <span class="item-name">';
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(5);
	module.exports=template('tpl/last','<div class="footer center border-top bg-white overflow"> <span class="color-green left-text center block margin-center" id="leftText" style="width:100%;"> <img src="../bundle/img/left-text-5685afef8e.png" style="width:14px;height:14px"> 上一题 </span> </div>');
