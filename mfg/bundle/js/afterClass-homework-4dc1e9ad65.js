	        ...
	        success:function(data){
	            w.checkBind(data);
	                ...
	                function backTostydy(){
	                    $("#rightText").click(function(){
	                        location.href="tody-study-65e925680b.html";
	                    })
	                }
	            }
	        },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(5);
	module.exports=template('tpl/footer_first_topic','<div class="footer center border-top bg-white overflow"> <span class="color-green right-text center block margin-center" id="rightText" style="width:100%;"> <img src="../bundle/img/right-text-d230cb1e77.png" style="width:14px;height:14px"> 下一题 </span> </div>');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(5);
	module.exports=template('tpl/footer_last_topic','<div class="footer center border-top bg-white overflow"> <span class="color-green left-text block left " style="border-right:1px solid #e4e4e4" id="leftText"> <img src="../bundle/img/left-text-5685afef8e.png" style="width:14px;height:14px"> 上一题 </span> <span class="color-green right-text block left" id="rightText"> <img src="../bundle/img/back-xueqing-3b751de717.png" style="width:14px;height:14px" >回到今日学情 </span> </div>');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(5);
	module.exports=template('tpl/footer-onetopic','<div class="footer center border-top bg-white overflow" > <span class="color-green right-text center block margin-center" id="rightText" style="width:100%;"> <img src="../bundle/img/back-xueqing-3b751de717.png" style="width:14px;height:14px"></i> 回到今日学情 </span> </div> ');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var template=__webpack_require__(5);
	module.exports=template('tpl/footer_center_topic','<div class="footer center border-top bg-white overflow" > <span class="color-green left-text center block left" id="leftText"> <img src="../bundle/img/left-text-5685afef8e.png" style="width:14px;height:14px"> 上一题 </span> <span class="color-green right-text center block left" id="rightText"> <img src="../bundle/img/right-text-d230cb1e77.png" style="width:14px;height:14px"> 下一题 </span> </div>');
