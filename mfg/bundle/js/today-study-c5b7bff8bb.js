	         ...
	         //开课提醒的数据
	          ...
	          var comparetime=function(gettime){
	            ...
	            $.each(datta,function(i,val) {
	                ...
	                str += '<div class="part speak '+val.id+'" id="'+val.id+'"><img src="../bundle/img/detail_03-467ee3324b.png" width="31" height="34"><span class="title">开讲啦</span><p>您好:<span class="first_span">' + val.userName + '</span>今天有课，快提醒他上课吧~</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span><span>(第'+ val.extendNum + '次)</span><span class="datatime">' + start+ '~' + end+ '</span></p></div>'
	             })
	            $('.main').append(str);
	            //快交作业了
	            ...
	            $.each(datta1,function(i,val) {
	                ...
	                var stageName = home.getStageStr(val.bgrade);
	                var courseName = home.getSubjectName(val.subject);
	                str1 += '<div class="part homework '+val.id+'" id="'+val.id+'"><img src="../bundle/img/detail_06-ed5783529e.png" width="31" height="34"><span class="title">快交作业啦</span><p>您好:<span class="first_span">' +val.userName + '</span>还有未交作业，快督促他交作业吧~</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span><span class="datatime">截止&nbsp;&nbsp;<span>'+comparetime(nowTimes)+'</span>&nbsp;' +start+ '</span></span></p></div>'
	             })
	            ...
	            $.each(datta2,function(i,val){
	                ...
	                var stageName = home.getStageStr(val.bgrade);
	                var courseName = home.getSubjectName(val.subject);
	                str2 += '<div class="part module '+val.id+'" id="'+val.id+'"><img src="../bundle/img/detail_09-0660522d57.png" width="31" height="34"><span class="title">收到一份新学案</span><p>您好:老师发布了新学案，快提醒<span class="first_span">' +val.userName + '</span>预习吧</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span>(第<span>' +val.extendNum + '</span>次)<span class="datatime">上课&nbsp;&nbsp&nbsp;<span class="time">' +mouth+ '月' +day+ '日&nbsp;' +date+ '</span></span></p></div>'
	            })
	            //新作业
	            $('.main').append(str2);
	            $.each(datta3,function(i,val){
	                ...
	                var stageName = home.getStageStr(val.bgrade);
	                var courseName = home.getSubjectName(val.subject);
	                str3 += '<div class="part newwork '+val.id+'" id="'+val.id+'"><img src="../bundle/img/detail-be7857270f.png" width="31" height="34"><span class="title">收到一份新作业</span><p>您好:老师布置了新作业，快督促<span class="first_span">' +val.userName + '</span>作答吧~</p><hr /><p  class="detailed"><span class="subject">' + stageName + '' + courseName + '</span><span class="datatime">截止&nbsp;&nbsp;&nbsp;<span>' +mouth+ '月' +day+ '日&nbsp;' +date+ '</span></span></p></div>';
	            })
	            $('.main').append(str3);
	        },
	        error: function (xhr, type) {
	            ...
	            //得到点击对象的id的值函数点击的时候跳转页面
	              var id=$(this).attr('id');
	               switch (clas)
	                {
	                    case '.homework':
	                        var url="today-work-a17e6ae748.html";
	                    ...
	                    case '.newwork':
	                        ...
	                        break;
	                    case '.module':
	                        var url="prepare-96330f9f4c.html";
	                        geturl(url,'workid',id);
	                        break;
	                    case '.speak':
	                        var url="prepare-96330f9f4c.html";
