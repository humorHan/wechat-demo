	...
	var comment = {
	    ...
	    initBtns: function(status){
	        ...
	        $('.handler').bind('touchend', function(){
	            location.href = encodeURI('./search-homework-subject-f80b45de1d.html' + '?stage-subject-name=' + $(".course-name").html() + '&homework-id=' + util.getQueryString("homework-id") + '&homework-status=' + status);
	        });
	    }
	};
	$(function(){
